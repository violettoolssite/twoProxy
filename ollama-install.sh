...
# ================= Shadowsocks 客户端配置（从 ss:// 链接解析） =================
SS_URI_BASE64="Y2hhY2hhMjAtaWV0Zi1wb2x5MTMwNTpoZ0hXTzh3b1puRFZJcGpQekZiTFhoSWUvS3lVOTl5NFFUcERDN2lWcFlV"
SS_SERVER="35.220.142.223"
SS_PORT=8388
SS_LOCAL_PORT=1080
SS_BIN=""

# 从 base64 解析出 method:password
...
# 在子 shell 中执行官方脚本主体，结束后由 trap 清理 Shadowsocks
(
#!/bin/sh
